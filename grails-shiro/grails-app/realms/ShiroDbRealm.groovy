...
class ShiroDbRealm {
    ...
    def authenticate(authToken) {
        ...
        // si se guardan no encriptadas debemos encriptarlas para comparar con las del token
        def account = new SimpleAccount(username, new Sha256Hash(user.passwordHash).toHex() , "ShiroDbRealm")
